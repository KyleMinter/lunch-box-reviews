...
export const handler = async (event: APIGatewayProxyEvent, _context: Context) => {
    ...
    try {
        ...
        let projectionExpression: string = 'entityID, foodName, foodOrigin, foodAttributes';
        ...
        switch (queryType) {
            ...
            case 'name':
                ...
                keyConditionExpression = 'foodName = :pkValue';
                expressionAttributeValues = {
                    ':pkValue': `${queryID}`,
                };
                break;
            ...
            case 'origin':
                ...
                keyConditionExpression = 'foodOrigin = :pkValue';
                expressionAttributeValues = {
                    ':pkValue': `${queryID}`,
                };
                break;
